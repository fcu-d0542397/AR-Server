...
public class noARServer {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < physicalX.length; i++) {
            physicalX[i] = -1;
            physicalY[i] = -1;
        }
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    else if (getIDString.equals("getDevices")) {
                        System.out.println("adssadasd");
                        String getDevicesSize = "";
                        for (int i = 0; i < physicalX.length; i++) {
                            if(physicalX[i]!=-1 && physicalY[i]!=-1){
                                if(getDevicesSize.equals("")){
                                    getDevicesSize = getDevicesSize +  String.valueOf(physicalY[i]);
                                    getDevicesSize = getDevicesSize +",";
                                    getDevicesSize = getDevicesSize +  String.valueOf(physicalX[i]);
                                }
                                else{
                                    getDevicesSize = getDevicesSize +",";
                                    getDevicesSize = getDevicesSize +  String.valueOf(physicalY[i]);
